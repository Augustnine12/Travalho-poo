...
public class ContaEnergia : Conta {
    ...
    public float Total { get; set; }
     ...
     public ContaEnergia(int id, float leituraMesAtual, float leituraMesAnterior, float valorUltimoMes, float totalSemImposto, float valorMedio, Consumidor consumidor,
        float contribuicaoIluminacaoPublica, float tarifaResidencial, float tarifaComercial, float impostoResidencial, float impostoComercial, float total)
        : base(id, leituraMesAtual, leituraMesAnterior, valorUltimoMes, totalSemImposto, valorMedio, consumidor)
    {
